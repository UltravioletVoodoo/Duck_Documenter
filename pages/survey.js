...
export default function Survey() {
    const [time, setTime] = useState(new Date().toISOString().slice(0, 10)) // Setting the default value to todays date
    ...
    return (
        <>
            <div>
                <input value={time} onChange={handleTimeChange} type='date'></input>
